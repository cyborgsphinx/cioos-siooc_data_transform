...
class OceanNcVar(object):
    ...
    def __get_bodc_code(self, vartype, ios_varname, varunits, iter):
        ...
        if vartype == "temperature":
            ...
            elif ios_varname.endswith("_11") and is_in(["pmol/l", "nmol/m^3"], varunits):
                bodc_code = "FR11GCTX"
                bodc_units = "pmol/L"
            ...
            elif ios_varname.endswith("_113") and is_in(["pmol/kg"], varunits):
                bodc_code = "F113GCKG"
                bodc_units = "pmol/kg"
            ...
            elif is_in(["phe"], ios_varname):
                bodc_code = "COPHWA09"
                self.long_name = "Concentration of pheophytin-a per unit volume of the water body"
            elif is_in(["b-car"], ios_varname):
                bodc_code = "BBCAMHP1"
                self.long_name = "Concentration of β-carotene unit volume of the water body"
            else:
                raise Exception(
            ...
            if is_in(["nitrate_plus_nitrite"], ios_varname) and is_in(
                ...
                bodc_code = "NTRIXXDZ"
                bodc_units = "umol/L"
                self.standard_name = "mole_concentration_of_nitrite_in_sea_water"
                self.long_name = "Mole Concentration of Nitrite in Sea Water"
            elif is_in(["nitrate"], ios_varname) and is_in(["umol/l"], varunits):
                bodc_code = "NTRAXXDZ"
                bodc_units = "umol/L"
                self.standard_name = "mole_concentration_of_nitrate_in_sea_water"
                self.long_name = "Mole Concentration of Nitrate in Sea Water"
            ...
            elif is_in(["turbidity:wetlabs"], ios_varname) and is_in(["ntu", "ftu", "stu"], varunits):
                bodc_code = "TURBXXXX"
                bodc_units = "ntu"
                self.standard_name = "sea_water_turbidity"
                self.long_name = "Turbidity of water in the water body"
            ...
            elif is_in(["hydrogen_sulfide"], ios_varname) and is_in(["umol/l"], varunits):
                bodc_code = "H2SXZZXX"
                bodc_units = "umol/L"
